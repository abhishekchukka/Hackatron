...
const PlayerDashboard = () => {
  ...
  const playerData = {
    fullName: "Abhishek Mahin Prabhas",
    email: "john@gmail.com",
    phone: "8919579260",
    gender: "female",
    dateOfBirth: "2025-02-02T18:30:00.000Z",
    primarySport: "Cricket",
    secondarySport: "Basketball",
    currentLevel: "Intermediate",
    playingExperience: "6",
    achievements: "Regional Champion 2024",
    currentClub: "Royal Challengers",
    coachDetails: "Coach Smith",
    height: "190",
    weight: "60",
    dominantSide: "both",
    bloodGroup: "A+",
    fitnessLevel: "Advanced",
    existingInjuries: true,
    medicalConditions: {
      asthma: false,
      diabetes: false,
      heartCondition: true,
    ...
    careerGoal: "Professional Athlete",
